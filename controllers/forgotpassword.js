                    ...
                    const receivers = [
                        {
                         ...
                         tranEmailApi.sendTransacEmail({
                             ...
                             htmlContent: `<a>Click <a href="http://localhost:8001/password/resetpassword/${id}">here</a> to reset your password for Nsnemo</a>`,
...
const resetpassword = async (req, res) => {
    ...
    try {
        ...
        if (forgotpasswordrequest) {
            ...
            const response = await axios.post('http://localhost:8001/password/updatepassword/${id}',data)
