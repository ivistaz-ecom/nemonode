                    ...
                    const receivers = [
                        {
                         ...
                         tranEmailApi.sendTransacEmail({
                             ...
                             htmlContent: `<a>Click <a href="http://nemonode.ivistaz.co:8000/candidate-password/resetpassword/${id}">here</a> to reset your password for Nsnemo</a>`,
...
const resetpassword = async (req, res) => {
    ...
    try {
        ...
        if (forgotpasswordrequest) {
            ...
            const response = await axios.post('http://nemonode.ivistaz.co:8000/candidate-password/updatepassword/${id}',data)
