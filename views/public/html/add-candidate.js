...
addcandidateButton.addEventListener("submit", async (e) => {
  ...
  try {
    ...
    if (photoFile) {
      photoFileName = await uploadFile(photoFile, `${config.APIURL}upload1`);
    }

    if (resumeFile) {
      resumeFileName = await uploadFile(resumeFile, `${config.APIURL}upload3`);
    }
    ...
    const candidate_details = {
      ...
      avb_date:
        document.getElementById("candidate_avb_date").value.trim() ||
        "1970-01-01",
      nationality: document
        .getElementById("candidate_nationality")
        .value.trim(),
      company_status: document
        .getElementById("candidate_company_status")
        .value.trim(),
      dob:
        document.getElementById("candidate_dob").value.trim() || "1970-01-01",
      birth_place: document
        .getElementById("candidate_birth_place")
        .value.trim(),
      work_nautilus: document
        .getElementById("candidate_work_nautilus")
        .value.trim(),
      ...
      boiler_suit_size: document
        .getElementById("candidate_boiler_suit_size")
        .value.trim(),
      safety_shoe_size: document
        .getElementById("candidate_safety_shoe_size")
        .value.trim(),
      ...
      indos_number: document
        .getElementById("candidate_indos_number")
        .value.trim(),
      ...
      nemo_source: abc,
      active_details:
        document.getElementById("candidate_active_details").value.trim() || 0,
      area_code1:
        document.getElementById("candidate_area_code1").value.trim() || "",
      area_code2:
        document.getElementById("candidate_area_code2").value.trim() || "",
      category: document.getElementById("candidate_category").value.trim() || 0,
      createdby: localStorage.getItem("username"),
      cr_date: date,
      cr_time: time,
      editedby:
        document.getElementById("candidate_editedby").value.trim() || "",
      imp_discussion:
        document.getElementById("candidate_imp_discussion").value.trim() || "",
      ipadress:
        document.getElementById("candidate_ipadress").value.trim() || "",
      joined_date:
        document.getElementById("candidate_joined_date").value.trim() ||
        "1970-01-01",
      last_company:
        document.getElementById("candidate_last_company").value || "",
      last_salary:
        document.getElementById("candidate_last_salary").value.trim() || "",
      las_date:
        document.getElementById("candidate_last_date").value.trim() ||
        "1970-01-01",
      las_time:
        document.getElementById("candidate_last_time").value.trim() || "",
      mobile_code1:
        document.getElementById("countryCodeSelect").value.trim() || "",
      mobile_code2:
        document.getElementById("countryCodeSelect2").value.trim() || "",
      mobile_status:
        document.getElementById("candidate_mobile_status").value.trim() || "",
      other_mobile_code:
        document.getElementById("candidate_other_mobile_code").value.trim() ||
        "",
      other_numbers:
        document.getElementById("candidate_other_numbers").value.trim() || "",
      p_ad1: document.getElementById("candidate_p_ad1").value.trim() || "",
      p_ad2: document.getElementById("candidate_p_ad2").value.trim() || "",
      p_country:
        document.getElementById("candidate_p_country").value.trim() || "",
