...
async function fetchAndDisplayBankDetails(candidateId) {
    try {
        ...
        bankDetails.forEach(bank => {
            ...
            <td><a href='${config.APIURL}views/public/bank_details/${bank.passbook}' target="_blank">Click here to view Document!</a></td>
            <td>${bank.pan_card}</td>

            <td><a href='${config.APIURL}views/public/bank_details/pan_card/${bank.pan_card}' target="_blank">Click here to view Document!</a></td>
            <td>${bank.branch}</td>
            <td>${bank.types}</td>
...
function deleteBank(bankId) {
    ...
    if (confirm("Are you sure you want to delete this bank?")) {
        ...
        axios.delete(`${config.APIURL}candidate/delete-bank/${bankId}`,{headers:{"Authorization":token}})
            .then(response => {
...
async function handleBankDetailsForm(event) {
    ...
    try {
        const response = await axios.post(`${config.APIURL}candidate/bank-details/${currentCandidateId}`, bankDetails, {
            headers: {
                'Authorization': token,
                'Content-Type': 'application/json'
            }
