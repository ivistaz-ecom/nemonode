...
const displayUserDropdown = async function () {
    ...
    evaluationForm.addEventListener('submit', async function(event) {
        ...
        try {
            ...
            const response = await axios.post(`http://localhost:4000/candidate/evaluation/${id}`, evaluationData);
    ...
    document.getElementById('evalType').addEventListener('change', function() {
        ...
        if (selectedType === '1') {
            remoteLinkInput.value = 'http://localhost:4000/views/public/html/engine-form.html';
        } else if (selectedType === '2') {
            remoteLinkInput.value = 'http://localhost:4000/views/public/html/deck-form.html';
        } else if (selectedType === '3') {
            remoteLinkInput.value = 'http://localhost:4000/views/public/html/galley-form.html';
        } else {
