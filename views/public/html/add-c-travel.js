    ...
    const id = candidateId;
        ...
        document.getElementById('travelForm').addEventListener('submit', async function (event) {
            ...
            try {
                ...
                const response = await axios.post(`http://nemonode.ivistaz.co/candidate/travel-details/${id}`,travelDetails, {headers:{"Authorization": token}});
        ...
        async function fetchAndDisplayTravelDetails() {
            try {
                ...
                const response = await axios.get(`http://nemonode.ivistaz.co/candidate/get-travel-details/${id}`, {
