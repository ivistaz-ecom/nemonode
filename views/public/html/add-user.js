...
//     try {
//         const response = await axios.post(`${config.APIURL}user/create-user`, formData, { headers: { "Authorization": token } });
...
const getUserEmail=() =>{
    ...
    async function displayUsers(Write) {
        try {   
            ...
            const response = await axios.get(`${config.APIURL}user/view-user`, { headers: { "Authorization": token, "userEmail": userEmail } });
    ...
    async function deleteUser(id) {
        if (confirm("Are you sure you want to delete this user?")) {
            try {
                ...
                const response = await axios.delete(`${config.APIURL}user/delete-user/${id}`, { headers: { "Authorization": token } });
