...
//     const specialCommentsUrl = `http://localhost:4000/candidate/get-discussionplus-details/${candidateId}`;
//     const candidateUrl = `http://localhost:4000/candidate/get-candidate/${candidateId}`;
//     try {
