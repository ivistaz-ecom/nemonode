...
async function fetchAndDisplayExp() {
    try {
        const serverResponse = await axios.get("http://nemonode.ivistaz.co/others/view-experience", { headers: { "Authorization": token } });
...
async function fetchAndDisplayGrades() {
    try {
        const serverResponse = await axios.get("http://nemonode.ivistaz.co/others/view-grade", { headers: { "Authorization": token } });
...
async function fetchAndDisplayNationalities() {
    try {
        const token = localStorage.getItem('token');
        const response = await axios.get("http://nemonode.ivistaz.co/fetch-nationality", { headers: { "Authorization": token } });
...
async function displayCandidateDetails(candidateData) {
    try {
        ...
        // const portResponse = await axios.get("http://nemonode.ivistaz.co/others/view-port", { headers: { "Authorization": token } });
        // const portOptions = portResponse.data.ports;
        // const portNames = portOptions.map(port => port.portName);

        // const documentResponse = await axios.get("http://nemonode.ivistaz.co/others/view-document", { headers: { "Authorization": token } });
        ...
        // const countryResponse = await axios.get("http://nemonode.ivistaz.co/fetch-nationality", { headers: { "Authorization": token } });
        ...
        // const gradeResponse = await axios.get("http://nemonode.ivistaz.co/others/view-grade", { headers: { "Authorization": token } });
        // const grades = gradeResponse.data.grades;
        // const gradeNames = grades.map(grade => grade.gradeExp);

        // const hospitalResponse = await axios.get("http://nemonode.ivistaz.co/others/view-hospital", { headers: { "Authorization": token } });
        ...
        // const portAgentResponse = await axios.get("http://nemonode.ivistaz.co/others/view-port-agent", { headers: { "Authorization": token } });
...
function formatDate(dateString) {
  ...
  async function fetchAndDisplayCandidate(candidateId,token) {
    try {
        const serverResponse = await axios.get(`http://nemonode.ivistaz.co/candidate/get-candidate/${candidateId}`, {
...
addcandidateButton.addEventListener("submit", async(e) =>{
    ...
    try {
        const serverResponse = await axios.put(`http://nemonode.ivistaz.co/candidate/update-candidate/${currentCandidateId}`, candidate_details,{headers:{"Authorization":token}});
