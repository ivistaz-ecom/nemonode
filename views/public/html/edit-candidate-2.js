...
const userName = localStorage.getItem('username')
    ...
    const candidate_details = {
        ...
        avb_date: document.getElementById('edit_candidate_avb_date').value || '1970-01-01',
        ...
        cr_date: document.getElementById('edit_candidate_created_date').value || '1970-01-01',
        ...
        joined_date: document.getElementById('edit_candidate_joined_date').value ||'1970-01-01',
    ...
    try {
        const response = await axios.put(`http://localhost:4000/candidate/update-candidate/${candidateId}`, candidate_details, {
            headers: {
                'Authorization': token
            }
        });
