...
const displayVesselTypeDropdown = async function () {
    try {
        ...
        const vesselResponse = await axios.get("http://nemonode.ivistaz.co/others/view-vessels", { headers: { "Authorization": token } });
...
const addCrewPlanner = async (e) => {
    ...
    try {
        ...
        const response = await axios.post('http://nemonode.ivistaz.co/others/add-crew-planner', formData, { headers: { "Authorization": token } });
...
async function fetchAndDisplayCrewPlannerDetails() {
    try {
        const response = await axios.get(`http://nemonode.ivistaz.co/others/view-crew-planner`, {
            headers: {
                'Authorization': token,
