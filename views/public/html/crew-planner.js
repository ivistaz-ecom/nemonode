...
const addCrewPlanner = async (e) => {
    ...
    try {
        ...
        const response = await axios.post('http://nemonode.ivistaz.co:8000/others/add-crew-planner', formData, { headers: { "Authorization": token } });
...
async function fetchAndDisplayCrewPlannerDetails() {
    try {
        const response = await axios.get(`http://nemonode.ivistaz.co:8000/others/view-crew-planner`, {
            headers: {
                'Authorization': token,
