...
function formatDate(dateString) {
  ...
  async function handleDueForWorkedWithSubmit() {
    try {
        ...
        const response = await axios.get(`https://nemo.ivistaz.co/others/worked`);
        ...
        candidatesWithNTBR.forEach(candidate => {
            ...
            candidateIdBtn.classList.add('btn', 'text-primary','p-0','m-0');
            candidateIdBtn.style.fontSize='7px'
