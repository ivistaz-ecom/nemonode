...
document.addEventListener('DOMContentLoaded',async function () 
{
    ...
    async function fetchAndDisplayExp() {
        try {
            const serverResponse = await axios.get(`http://nemonode.ivistaz.co/others/get-experiences`);
   ...
   await  fetchData();
    ...
    async function updateCandidate(candidateData) {
        try {
            const response = await axios.put(`http://nemonode.ivistaz.co/candidate/update-c-candidate/${cmemId}`, candidateData);
            const responseData = response.data;
