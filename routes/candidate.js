...
router.get('/vesselassignment',candidateControllers.vesselAssignment)
...
router.get('/evaluationcount',candidateControllers.getEvaluationCount)
...
router.get('/signondgcount',candidateControllers.getContractSignOnDGCount)
router.get('/signoffdgcount',candidateControllers.getContractSignOffDGCount)
router.get('/contractextensioncount',candidateControllers.getcontractExtensionCount)
router.get('/ecoexceededCount',candidateControllers.getEOCExceededCount)
router.get('/rankwisecallsmade',candidateControllers.getRankWiseCallsMadeCount)
